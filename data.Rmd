...
# r.download_file_list = ['2024111', '2024112']
...
if(file.exists(file.path(paste0(data_path,"gis/map_7d_pre.jpg")))){file.remove(file.path(paste0(data_path,"gis/map_7d_pre.jpg")))}
arcgisbinding::arc.write(path = paste0(data_path,"gis/map_7d_pre.jpg"), data = lakes.resolvable.7d)
