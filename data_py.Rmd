...
field_data_clean <- field_data %>%
  ...
  dplyr::select(MLocID,StationDes,Lat_DD,Long_DD,SampleStartDate,Char_Name,Result_Numeric,Result_Unit,GNIS_Name_ID,
                Result_status,DQL,QualifierAbbr,Result_Type,MonLocType,`Project1`) %>% 
