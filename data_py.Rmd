...
data_field <- readxl::read_excel(paste0(data_path,"field_data_2025.xlsx"))
...
writexl::write_xlsx(field_data, paste0(data_path,"field_data_all_2025.xlsx"))
...
writexl::write_xlsx(field_data_clean, paste0(data_path,"field_data_2025.xlsx"))
...
# Field data ----
dta_field_1 <- readxl::read_excel(paste0(data_path,"field_data_2025.xlsx"))

dta_field_2 <- readxl::read_excel(paste0(data_path,"field_data_1999-2024.xlsx"))
...
# Advisories ----
dta_adv_1 <- readxl::read_excel(paste0(data_path,"OHA_advisories_2007-2024.xlsx"), sheet = "Advisories")

dta_adv_2 <- readxl::read_excel(paste0(data_path,"OHA_advisories_2025.xlsx"), sheet = "Advisories") %>% 
...
map.tbl.data <- dta_wide %>% 
  ...
  # dplyr::filter(!`Waterbody_GNISID*` %in% c("Timothy Lake_01151253")) # 20251112
