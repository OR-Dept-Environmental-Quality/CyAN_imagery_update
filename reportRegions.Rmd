...
Below is the update for satellite imagery estimates of cyanobacteria in `r unique(bc_region$REGION)` waterbodies.
...
knitr::kable(tbl.7dmdm[1:num,], caption = caption.region)
